...
maui is only tested with Python 3.6, but probably works on 3.5+. The pakcage may be installed by cloning this repo and running `python setup.py install`, or, using `pip` directly from github:
